...
public class ComputadorService {
	...
	private DAO produtoDAO = new DAO();
	private String form;
	...
	public void makeForm() {
		makeForm(FORM_INSERT, new ComputerParts(), FORM_ORDERBY_DESCRICAO);
	}

	
	public void makeForm(int orderBy) {
		makeForm(FORM_INSERT, new ComputerParts(), orderBy);
	}

	
	public void makeForm(int tipo, ComputerParts produto, int orderBy) {
		...
		if(tipo != FORM_INSERT) {
			...
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;<a href=\"/produto/list/1\">Nova Parte</a></b></font></td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t</table>";
			umProduto += "\t<br>";			
		}
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			if (tipo == FORM_INSERT){
				...
				descricao = "placa de video, memoria, hdd...";
				buttonLabel = "Inserir";
			} else {
	...
	public Object insert(Request request, Response response) {
		...
		ComputerParts produto = new ComputerParts(-1, descricao, preco, quantidade);
	...
	public Object get(Request request, Response response) {
		...
		ComputerParts produto = (ComputerParts) produtoDAO.get(id);
	...
	public Object update(Request request, Response response) {
        int id = Integer.parseInt(request.params(":id"));
        ComputerParts produto = produtoDAO.get(id);
        String resp = "";       
